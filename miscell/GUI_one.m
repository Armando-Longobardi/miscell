function GUI_one(MainPanel)
% ==================================
% VERSION 1.0
%   - First release based on BasicModule v1.1
% ==================================
VERSION = '1.0';
...
ax=axes('parent',MainPanel, ...
    'units','norm', 'pos', [0.52, 0.5, 0.4, 0.25])   ;   %% far uscire assi

button1=uicontrol('parent',MainPanel, ...
    'units','norm', 'pos', [0.22, 0.1, 0.1, 0.03], ...
    'String','Hello', ...
    'Callback',@fun1, 'tag','b1');

%
InitVarsByTag(button1, {'String', 'BackgroundColor'});



    function fun1(obj,ev)   %oggetto,evento (servono, anche se nn usati)
        plot(ax,[1 2 3 4],'Color',rand(1,3));
    end
