function [ indice_new, target_new, i_count_new ] = file_searcher_v3( start,excel_name,excel_dir,indice, target, i_count )
...
excel_sheet_name=dir_name(local_path);
...
if isempty(folders)
    ...
    %provo ad aggiungere il link tra cartella e propria sheet
...
if target(i_count)==indice(i_count)
    ...
    file_searcher_v3( start,excel_name,excel_dir,indice_new, target, i_count_new );
else
