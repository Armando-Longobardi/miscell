...
% selected, you must use the 'X' on the axes to close the new figure.)
...
%    capabilities.
% 01/05/2015
%    R2014b compatibility

% Operate on current axes if no handle list is provided.
if nargin == 0
	hndls = gca;
end
if nargin < 2
